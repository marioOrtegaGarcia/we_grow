...
import 'package:we_grow/theme/shared_styles.dart' as sharedStyles;

class ExpansionListWidget<T> extends StatefulWidget {
  final List<T> items;
  final String title;
  ...
  _ExpansionListWidgetState createState() => _ExpansionListWidgetState();
}
